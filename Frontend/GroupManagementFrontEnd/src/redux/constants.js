...
export const GET_LIST_TRIP_SELECTED_ROWS = "GET_LIST_TRIP_SELECTED_ROWS";
export const GET_TRIPBYCODE="GET_TRIPBYCODE"
//tour
...
export const GET_BOOKING_BY_USER = "GET_BOOKING_BY_USER";
